  ...
  return (
    <div className="space-y-4">
      {cards.map((card) => (
        <Card 
          key={card.id} 
          className={`bg-card border-border/50 shadow-card transition-all duration-300 ${
            expandedCard === card.id ? 'shadow-lg ring-2 ring-primary/20' : 'hover:shadow-md cursor-pointer'
          }`}
        >
          ...
          {expandedCard === card.id && (
            <div className="px-6 pb-6 animate-fade-in-up">
              ...
              {/* Absent Reps Detail View */}
              {card.id === "absent" && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h4 className="text-base font-semibold text-foreground">Sales Representatives</h4>
              ...
              {/* At-Risk Revenue Detail View */}
              {card.id === "at-risk" && (
                <div className="space-y-6">
                  <h4 className="text-base font-semibold text-foreground">Revenue Breakdown</h4>
              ...
              {/* Recoverable Revenue Detail View */}
              {card.id === "recoverable" && (
                <div className="space-y-6">
                  <h4 className="text-base font-semibold text-foreground">Recovery Opportunities</h4>
              ...
              {/* Ready to Launch Detail View */}
              {card.id === "ready" && (
                <div className="space-y-6">
                  <h4 className="text-base font-semibold text-foreground">System Configuration</h4>
